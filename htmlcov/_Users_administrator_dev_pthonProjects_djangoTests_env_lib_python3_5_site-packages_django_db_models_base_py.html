...
<head>
    ...
    <title>Coverage for /Users/administrator/dev/pthonProjects/djangoTests/env/lib/python3.5/site-packages/django/db/models/base.py: 33%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/Users/administrator/dev/pthonProjects/djangoTests/env/lib/python3.5/site-packages/django/db/models/base.py</b> :
...
<p id="t633" class="stm mis">                <span class="key">if</span> <span class="nam">local_val</span> <span class="op">!=</span> <span class="nam">related_val</span> <span class="key">or</span> <span class="op">(</span><span class="nam">local_val</span> <span class="key">is</span> <span class="key">None</span> <span class="key">and</span> <span class="nam">related_val</span> <span class="key">is</span> <span class="key">None</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t682" class="stm mis">                <span class="key">if</span> <span class="nam">obj</span> <span class="key">and</span> <span class="nam">obj</span><span class="op">.</span><span class="nam">pk</span> <span class="key">is</span> <span class="key">None</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t692" class="stm run hide_run">        <span class="key">if</span> <span class="nam">update_fields</span> <span class="key">is</span> <span class="key">not</span> <span class="key">None</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t735" class="stm run hide_run">    <span class="nam">save</span><span class="op">.</span><span class="nam">alters_data</span> <span class="op">=</span> <span class="key">True</span><span class="strut">&nbsp;</span></p>
<p id="t736" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t737" class="stm run hide_run">    <span class="key">def</span> <span class="nam">save_base</span><span class="op">(</span><span class="nam">self</span><span class="op">,</span> <span class="nam">raw</span><span class="op">=</span><span class="key">False</span><span class="op">,</span> <span class="nam">force_insert</span><span class="op">=</span><span class="key">False</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
<p id="t738" class="pln">                  <span class="nam">force_update</span><span class="op">=</span><span class="key">False</span><span class="op">,</span> <span class="nam">using</span><span class="op">=</span><span class="key">None</span><span class="op">,</span> <span class="nam">update_fields</span><span class="op">=</span><span class="key">None</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t766" class="stm run hide_run">        <span class="nam">self</span><span class="op">.</span><span class="nam">_state</span><span class="op">.</span><span class="nam">adding</span> <span class="op">=</span> <span class="key">False</span><span class="strut">&nbsp;</span></p>
...
<p id="t773" class="stm run hide_run">    <span class="nam">save_base</span><span class="op">.</span><span class="nam">alters_data</span> <span class="op">=</span> <span class="key">True</span><span class="strut">&nbsp;</span></p>
...
<p id="t799" class="stm run hide_run">    <span class="key">def</span> <span class="nam">_save_table</span><span class="op">(</span><span class="nam">self</span><span class="op">,</span> <span class="nam">raw</span><span class="op">=</span><span class="key">False</span><span class="op">,</span> <span class="nam">cls</span><span class="op">=</span><span class="key">None</span><span class="op">,</span> <span class="nam">force_insert</span><span class="op">=</span><span class="key">False</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t813" class="stm run hide_run">        <span class="key">if</span> <span class="nam">pk_val</span> <span class="key">is</span> <span class="key">None</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t816" class="stm run hide_run">        <span class="nam">pk_set</span> <span class="op">=</span> <span class="nam">pk_val</span> <span class="key">is</span> <span class="key">not</span> <span class="key">None</span><span class="strut">&nbsp;</span></p>
...
<p id="t819" class="stm run hide_run">        <span class="nam">updated</span> <span class="op">=</span> <span class="key">False</span><span class="strut">&nbsp;</span></p>
...
<p id="t887" class="stm run hide_run">    <span class="key">def</span> <span class="nam">delete</span><span class="op">(</span><span class="nam">self</span><span class="op">,</span> <span class="nam">using</span><span class="op">=</span><span class="key">None</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t889" class="stm mis">        <span class="key">assert</span> <span class="nam">self</span><span class="op">.</span><span class="nam">_get_pk_val</span><span class="op">(</span><span class="op">)</span> <span class="key">is</span> <span class="key">not</span> <span class="key">None</span><span class="op">,</span> <span class="op">(</span><span class="strut">&nbsp;</span></p>
...
<p id="t898" class="stm run hide_run">    <span class="nam">delete</span><span class="op">.</span><span class="nam">alters_data</span> <span class="op">=</span> <span class="key">True</span><span class="strut">&nbsp;</span></p>
...
<p id="t937" class="stm mis">        <span class="key">if</span> <span class="nam">self</span><span class="op">.</span><span class="nam">pk</span> <span class="key">is</span> <span class="key">None</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t950" class="stm run hide_run">    <span class="key">def</span> <span class="nam">validate_unique</span><span class="op">(</span><span class="nam">self</span><span class="op">,</span> <span class="nam">exclude</span><span class="op">=</span><span class="key">None</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t966" class="stm run hide_run">    <span class="key">def</span> <span class="nam">_get_unique_checks</span><span class="op">(</span><span class="nam">self</span><span class="op">,</span> <span class="nam">exclude</span><span class="op">=</span><span class="key">None</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t975" class="stm mis">        <span class="key">if</span> <span class="nam">exclude</span> <span class="key">is</span> <span class="key">None</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t1029" class="stm mis">                <span class="key">if</span> <span class="nam">lookup_value</span> <span class="key">is</span> <span class="key">None</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t1050" class="stm mis">            <span class="key">if</span> <span class="key">not</span> <span class="nam">self</span><span class="op">.</span><span class="nam">_state</span><span class="op">.</span><span class="nam">adding</span> <span class="key">and</span> <span class="nam">model_class_pk</span> <span class="key">is</span> <span class="key">not</span> <span class="key">None</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t1068" class="stm mis">            <span class="key">if</span> <span class="nam">date</span> <span class="key">is</span> <span class="key">None</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t1081" class="stm mis">            <span class="key">if</span> <span class="key">not</span> <span class="nam">self</span><span class="op">.</span><span class="nam">_state</span><span class="op">.</span><span class="nam">adding</span> <span class="key">and</span> <span class="nam">self</span><span class="op">.</span><span class="nam">pk</span> <span class="key">is</span> <span class="key">not</span> <span class="key">None</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t1137" class="stm run hide_run">    <span class="key">def</span> <span class="nam">full_clean</span><span class="op">(</span><span class="nam">self</span><span class="op">,</span> <span class="nam">exclude</span><span class="op">=</span><span class="key">None</span><span class="op">,</span> <span class="nam">validate_unique</span><span class="op">=</span><span class="key">True</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t1173" class="stm run hide_run">    <span class="key">def</span> <span class="nam">clean_fields</span><span class="op">(</span><span class="nam">self</span><span class="op">,</span> <span class="nam">exclude</span><span class="op">=</span><span class="key">None</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t1178" class="stm mis">        <span class="key">if</span> <span class="nam">exclude</span> <span class="key">is</span> <span class="key">None</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t1232" class="pln">                        <span class="nam">hint</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
<p id="t1233" class="pln">                        <span class="nam">obj</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t1245" class="pln">                        <span class="nam">hint</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
<p id="t1246" class="pln">                        <span class="nam">obj</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t1260" class="pln">                        <span class="nam">hint</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
<p id="t1261" class="pln">                        <span class="nam">obj</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t1313" class="pln">                        <span class="nam">hint</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t1334" class="pln">                    <span class="nam">hint</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t1362" class="pln">                            <span class="nam">hint</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t1387" class="pln">                        <span class="nam">hint</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t1429" class="pln">                    <span class="nam">hint</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t1440" class="pln">                    <span class="nam">hint</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t1459" class="pln">                    <span class="nam">hint</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t1489" class="pln">            <span class="nam">field</span><span class="op">.</span><span class="nam">name</span><span class="op">:</span> <span class="nam">field</span> <span class="key">for</span> <span class="nam">field</span> <span class="key">in</span> <span class="nam">cls</span><span class="op">.</span><span class="nam">_meta</span><span class="op">.</span><span class="nam">_get_fields</span><span class="op">(</span><span class="nam">reverse</span><span class="op">=</span><span class="key">False</span><span class="op">)</span><span class="strut">&nbsp;</span></p>
...
<p id="t1502" class="pln">                        <span class="nam">hint</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t1547" class="pln">                    <span class="nam">hint</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t1590" class="pln">                    <span class="nam">hint</span><span class="op">=</span><span class="key">None</span><span class="op">,</span><span class="strut">&nbsp;</span></p>
...
<p id="t1604" class="stm mis">        <span class="nam">allowed_len</span> <span class="op">=</span> <span class="key">None</span><span class="strut">&nbsp;</span></p>
<p id="t1605" class="stm mis">        <span class="nam">db_alias</span> <span class="op">=</span> <span class="key">None</span><span class="strut">&nbsp;</span></p>
...
<p id="t1617" class="stm mis">                <span class="key">if</span> <span class="nam">allowed_len</span> <span class="key">is</span> <span class="key">None</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t1624" class="stm mis">        <span class="key">if</span> <span class="nam">allowed_len</span> <span class="key">is</span> <span class="key">None</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t1632" class="stm mis">            <span class="key">if</span> <span class="op">(</span><span class="nam">f</span><span class="op">.</span><span class="nam">db_column</span> <span class="key">is</span> <span class="key">None</span> <span class="key">and</span> <span class="nam">column_name</span> <span class="key">is</span> <span class="key">not</span> <span class="key">None</span><span class="strut">&nbsp;</span></p>
...
<p id="t1650" class="stm mis">                <span class="key">if</span> <span class="op">(</span><span class="nam">m2m</span><span class="op">.</span><span class="nam">db_column</span> <span class="key">is</span> <span class="key">None</span> <span class="key">and</span> <span class="nam">rel_name</span> <span class="key">is</span> <span class="key">not</span> <span class="key">None</span><span class="strut">&nbsp;</span></p>
...
<p id="t1674" class="stm run hide_run"><span class="key">def</span> <span class="nam">method_set_order</span><span class="op">(</span><span class="nam">ordered_obj</span><span class="op">,</span> <span class="nam">self</span><span class="op">,</span> <span class="nam">id_list</span><span class="op">,</span> <span class="nam">using</span><span class="op">=</span><span class="key">None</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t1675" class="stm mis">    <span class="key">if</span> <span class="nam">using</span> <span class="key">is</span> <span class="key">None</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t1719" class="stm run hide_run"><span class="nam">model_unpickle</span><span class="op">.</span><span class="nam">__safe_for_unpickle__</span> <span class="op">=</span> <span class="key">True</span><span class="strut">&nbsp;</span></p>
